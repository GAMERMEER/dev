	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'stage': //Week 1
				...
				case 'park': //songweek
				var park:BGSprite = new BGSprite('park', -600, -250, 0.9, 0.9);
				add(park);
				...
				case 'hacker':
			{
				defaultCamZoom = 0.85;
				curStage = 'hacker';
				var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('hacker'));
	...
	public function endSong():Void
	{
		...
		if(achievementObj != null) {
			...
			var achieve:String = checkForAchievement(['week1_nomiss', 'week2_nomiss', 'week3_nomiss', 'week4_nomiss',
				...
				'ur_good', 'hype', 'two_keys', 'toastie', 'debugger', 'spirriter']);
